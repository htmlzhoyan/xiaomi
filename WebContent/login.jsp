...
<html>
	...
	<body>
		...
		<form  method="post" action="" class="form center" onsubmit="return false">
		<div class="login">
			<div class="login_center">
				...
				<div class="login_main center">
					...
					<div class="username">
						<div class="left fl">验证码:&nbsp;<input class="yanzhengma" type="text" name="vlidateCode" placeholder="请输入验证码"/></div>
						<div class="right fl"><img style="cursor: pointer;" id="codeImg" src="createCode"></div>
						<div class="clear"></div>
					</div>
				</div>
